  ...
  return (
    <>
      <main>
        ...
        <h2>Principais Alegações de Velikovsky</h2>
        <p>
        ...
        <h2>Rejeição pela Comunidade Científica</h2>
        <p>
        ...
        <ul>
          <li><strong>Contradição com a Física Planetária:</strong> Os astrônomos apontaram que a teoria de Velikovsky violava as leis da física, especialmente as leis de movimento e gravidade de Isaac Newton.</li>
          <li><strong>Ausência de Evidências Geológicas:</strong> Geólogos criticaram a falta de evidências físicas que sustentassem a alegação de Velikovsky de que a Terra sofreu catástrofes globais recentes causadas por interações planetárias.</li>
          <li><strong>Cronologia Incompatível:</strong> A cronologia proposta por Velikovsky, de que esses eventos catastróficos ocorreram em tempos históricos, era incompatível com o entendimento científico da evolução do sistema solar.</li>
          <li><strong>Falhas nas Previsões:</strong> Ao longo de suas obras, Velikovsky fez várias previsões baseadas em sua teoria. Algumas, como a previsão sobre a temperatura de Vênus, se mostraram corretas, mas por razões diferentes das que ele propôs.</li>
        </ul>

        <h2>Impacto Popular e Pseudociência</h2>
        <p>
